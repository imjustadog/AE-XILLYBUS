...
xst -ifn xst.scr
move xilinx_pcie_1_1_ep_s6.ngc .\results\pcie_top.ngc

cd results

echo 'Running ngdbuild'
ngdbuild -verbose -uc ..\..\example_design\xilinx_pcie_1_lane_ep_xc6slx45t-csg324-3.ucf pcie_top.ngc
echo 'Running map'
map -o mapped.ncd pcie_top.ngd mapped.pcf
