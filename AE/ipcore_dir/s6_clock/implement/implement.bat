...
xst -ifn xst.scr
move s6_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\s6_clock.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc s6_clock.ucf s6_clock_exdes

echo 'Running map'
map -timing -pr b s6_clock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm s6_clock_exdes -w routed.ncd routed.v
cd ..
